...
if($_SERVER["REQUEST_METHOD"] == "POST")  {
    ...
    $default_second = '<img src="img/default.png">';
        ...
        if($group) {
            ...
            $maRequetee = $pdo->prepare("INSERT INTO groupe_2 (name,id,profile_picture,seconde_picture,admin) values (:name,:id,:profile_picture,:seconde_picture,:admin)");  
            $maRequetee->execute([
                ":id" => $id,
                ":name" => $group,
            ...
            $marequet = $pdo->prepare("INSERT INTO admin_groupe (user,group_id) values(:id,:group_id)");  
            $marequet->execute([
                ":id" => $id,
                ":group_id" => $group_id
            ]);
...
<head>
    ...
    <div id="content">
        ...
        <form method="post">
            <label for="text">Nom du groupe public</label>
